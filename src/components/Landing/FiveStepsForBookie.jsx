            ...
            <Box>
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item lg={6} sm={12} xl={6} xs={12} sx={{ textAlign: 'left', alignSelf: 'center' }} >
                        ...
                        <Typography sx={{ fontWeight: '400', marginBottom: '16px', color: 'white', fontSize: '18px', width: '80%' }}>
                            BetBase is fully integrated with MetaMask, connected your MetaMask account to our app simply by clicking the 
                            <Button
                         ...
                         on the top right corner of the app. <br/><br/>By following this route over a traditional login approach, all Bettors and Bookies can remain anonymous to BetBase. The only identification factor is the public wallet address one uses to make bets or provide liquidity.
                        </Typography>
                    </Grid>
                </Grid>
                ...
                <Grid container spacing={3}>
                    <Grid item lg={6} sm={12} xl={6} xs={12} sx={{ textAlign: 'left', alignSelf: 'center' }} >
                        ...
                        <Typography sx={{ fontWeight: '400', marginBottom: '16px', color: 'white', fontSize: '18px', width: '80%' }}>
                        Just as straightforward as it is on the betting side, this step only requires the prospective Bookie to click their way to the Bookie side of BetBase in our web interface. On the Bookie side, there are only a few pages and shuffling through them is useful for all BetBase users. One of these pages has buttons to stake DAI in our Liquidity Pool. This is the page where Bookies will add and withdraw their stake in the pool.
                        </Typography>
                    </Grid>
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item lg={6} sm={12} xl={6} xs={12} sx={{ textAlign: 'left', alignSelf: 'center' }} >
                        ...
                        <Typography sx={{ fontWeight: '400', marginBottom: '16px', color: 'white', fontSize: '18px', width: '80%' }}>
                            Staking, providing liquidity, and becoming a Bookie are all for the most part synonymous at BetBase. Simply input the amount to stake, and click the “Stake DAI” button! The transaction confirmations will appear in MetaMask just like when placing bets. After the transaction is confirmed, the protocol will send the new Bookie a one-to-one amount of ERC-1155 token to DAI staked. We’ll refer to these tokens as BetBase Stake Tokens from now on.
                        </Typography>
                    </Grid>
                </Grid>
                ...
                <Grid container spacing={3}>
                    <Grid item lg={6} sm={12} xl={6} xs={12} sx={{ textAlign: 'left', alignSelf: 'center' }} >
                        ...
                        <Typography sx={{ fontWeight: '400', marginBottom: '16px', color: 'white', fontSize: '18px', width: '80%' }}>
                        Possessing the BetBase Stake Tokens in their MetaMask wallet, Bookies at any time can return to the Bookie side pages and check on things. The state of the BetBase Liquidity Pool is all open data on the blockchain, so we have built a simple interface to visualize these stats. The growth of the pool and the profits for the Bookie can be monitored with ease.
                        </Typography>
                    </Grid>
